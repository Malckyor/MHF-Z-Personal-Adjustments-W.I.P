...
***Important note: My personal adjustments are basically reverting back the content/system before the Refinement updates that happened in G9.1 and G10.1, this was when Armor Spheres replaced monster mats for armor upgrades, it also removed the old HR/SR system from the game which me and a few other people are still trying to revert back. This effort is just to make the game enjoyable like it was ever intended to be but for some reasons COG decided to change and from that point the game was literally instantly killed, unlike people assume, COG didn't shutdown Fronter's server because of MHW, if you are determined and interested you can search for interviews to check what they said about it. Anyway, I'm not modding the game to be a "Community Edition", I'm modding it to be again like it should always have been and like a lot of the older Frontier players prefers. Enjoy all modded version at your own risk and if you want to play it like it ever was, stick to my main Personal Adjustments and you'll have the closest experience to how it was, at least until it can be improved or someone else makes a better version.***
